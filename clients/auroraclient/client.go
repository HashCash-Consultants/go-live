...
// See https://www.hcnet.org/developers/aurora/reference/endpoints/accounts.html
...
// See https://www.hcnet.org/developers/aurora/reference/endpoints/offer-details.html
...
// See https://www.hcnet.org/developers/aurora/reference/resources/operation.html
...
// Paths returns the available paths to make a strict receive path payment. See https://www.hcnet.org/developers/aurora/reference/endpoints/path-finding-strict-receive.html
...
// StrictReceivePaths returns the available paths to make a strict receive path payment. See https://www.hcnet.org/developers/aurora/reference/endpoints/path-finding-strict-receive.html
func (c *Client) StrictReceivePaths(request PathsRequest) (paths hProtocol.PathsPage, err error) {
	err = c.sendRequest(request, &paths)
	return
}

// StrictSendPaths returns the available paths to make a strict send path payment. See https://www.hcnet.org/developers/aurora/reference/endpoints/path-finding-strict-send.html
