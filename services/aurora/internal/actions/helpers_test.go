...
func TestActionGetPageQuery(t *testing.T) {
	...
	// regression: https://github.com/HashCash-Consultants/go/services/aurora/internal/issues/372
...
func TestGetURLParam(t *testing.T) {
	...
	// Regression for https://github.com/HashCash-Consultants/go/issues/1965
