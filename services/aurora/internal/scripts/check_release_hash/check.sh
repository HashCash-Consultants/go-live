...
wget https://github.com/HashCash-Consultants/go/releases/download/$TAG/$TAG-darwin-amd64.tar.gz
wget https://github.com/HashCash-Consultants/go/releases/download/$TAG/$TAG-linux-amd64.tar.gz
wget https://github.com/HashCash-Consultants/go/releases/download/$TAG/$TAG-linux-arm.tar.gz
wget https://github.com/HashCash-Consultants/go/releases/download/$TAG/$TAG-windows-amd64.zip
