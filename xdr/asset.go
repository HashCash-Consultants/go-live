...
// https://github.com/HashCash-Consultants/hcnet-protocol/pull/313
...
func BuildAssets(s string) ([]Asset, error) {
	...
	for _, assetString := range assetStrings {
		...
		// Technically https://github.com/HashCash-Consultants/hcnet-protocol/blob/master/ecosystem/sep-0011.md allows
